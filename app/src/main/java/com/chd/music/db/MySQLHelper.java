...
public class MySQLHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE download_finish (objid TEXT PRIMARY KEY ,time INTEGER ,size INTEGER,name text )");
		...
		db.execSQL("CREATE UNIQUE INDEX upload_sysid_idx ON upload_inter (sysid)");
	}
