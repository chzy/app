...
public class FileOpenUtils {
	public static Intent openFile(String filePath) {
		...
		} else if (end.equalsIgnoreCase("3gp") || end.equalsIgnoreCase("mp4")||end.equalsIgnoreCase("rmvb")||end.equalsIgnoreCase("RM")||end.equalsIgnoreCase("AVI")||end.equalsIgnoreCase("WMV")||end.equalsIgnoreCase("MPEG")||end.equalsIgnoreCase("VOB")||end.equalsIgnoreCase("FLV")) {
