...
import com.lockscreen.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	private void saveChosenPatternAndFinish() {
		UILApplication.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		showToast("密码设置成功");
		startActivity(new Intent(this,UnlockGesturePassword2Activity.class));
		finish();
	}
}
